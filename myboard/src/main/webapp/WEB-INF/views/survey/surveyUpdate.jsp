...
$(document).ready(function(){
	...
	$("#s_gender").val("${data.s_gender}").attr("selected", "selected"); //성별 체크
	$("[name=s_age]").filter("[value=${data.s_age}]").prop("checked",true)
	$("input:checkbox[name='s_purpose_of_visit']:checkbox[value='${data.s_purpose_of_visit }']").prop('checked', true);
	$("input:checkbox[name='s_level_of_satisfaction']:checkbox[value='${data.s_level_of_satisfaction }']").prop('checked', true);
...
<br>
	...
	<p>설문조사 수정 페이지</p>
	<form name="surveyUpdate" class="center" method="POST" action="${path}/survey/surveyUpdate?s_idx=${data.s_idx}">
	<table class="table">
		<tr>
		...
		<tr>
			...
			<td>
				<select name="s_gender" id="s_gender" class="form-select" aria-label="Default select example">
		...
		<tr>
			...
			<td>
				<input type="radio" class="form-check-input" id="s_age" name="s_age" value="10대"> 10대 
				<input type="radio" class="form-check-input" id="s_age" name="s_age" value="20대"> 20대 
				<input type="radio" class="form-check-input" id="s_age" name="s_age" value="30대"> 30대 
				<input type="radio" class="form-check-input" id="s_age" name="s_age" value="40대"> 40대 
				<input type="radio" class="form-check-input" id="s_age" name="s_age" value="50대"> 50대 
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><textarea name="s_improvements" class="form-control" cols="60" rows="5" >${data.s_improvements} </textarea></td>
		</tr>
		<tr>
			<td colspan="2">
				<button type="submit" class="btn btn-outline-info">수정</button>
	 		<a href = "/survey/surveyDelete?s_idx=${data.s_idx }" role="button" class="btn btn-outline-info">삭제</a>
